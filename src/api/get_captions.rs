...
mod tests {
    ...
    async fn create_get_captions_url() {
        ...
        assert_eq!("https://subsonic.example/rest/getCaptions?u=peter&v=v0.16.1&c=submarine-lib&t=d4a5b2db9781fba37ec95f0312ade67a&s=&f=json&id=testId", &url.to_string());
    }
}
